...
function UsageTable({ rows }: { rows: MonthlyUsage[] }) {
  if (rows.length === 0) {
    return <div className="text-center py-8 text-gray-500 text-sm">No usage data yet.</div>;
  }
      ...
      <table className="w-full text-sm">
        <thead>
          <tr className="border-b border-gray-800 bg-gray-800/40">
            ...
            <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Input</th>
            <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Output</th>
            <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Total</th>
            <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Cost</th>
            <th className="text-left px-4 py-3 text-xs font-medium text-gray-400 uppercase tracking-wider">Calls</th>
          </tr>
        </thead>
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        {myUsage.isLoading ? (
          ...
          <div className="text-sm text-gray-500 py-4">No usage this month.</div>
        )}

        {/* My history */}
        {myUsage.data.length > 0 && (
          <div>
            <h4 className="text-xs text-gray-400 uppercase tracking-wider mb-2">Monthly History</h4>
