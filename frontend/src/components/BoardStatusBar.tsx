                      ...
                      return (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="flex items-center justify-center w-5 h-5 text-xs text-gray-600 hover:text-purple-400 hover:bg-purple-500/10 rounded opacity-0 group-hover:opacity-100 transition-all flex-shrink-0"
